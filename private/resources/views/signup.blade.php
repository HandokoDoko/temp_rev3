...
<head>
                ...
                <div class="collapse navbar-collapse" >
                    <ul class="nav navbar-nav navbar-right navbar-uppercase">
                        <li class="social-links">
                            <a href="https://www.facebook.com/certivyTim">
                                <i class="fa fa-facebook-square"></i>
                            </a>
                            <a href="https://twitter.com/certivyTim">
                                <i class="fa fa-twitter"></i>
                            </a>
                            <a href="https://plus.google.com/+certivytimPage">
                                <i class="fa fa-google-plus-square"></i>
                            </a>
                            <a href="https://dribbble.com/certivytim">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="panel panel-white">
                                    <div class="panel-body">
                                        ...
                                        <hr>
                                        <form action="./panitia" role="form" id="form" >
                                            <div class="row">
                                                <div class="col-md-12">
    ...
    <script type="text/javascript">
        ...
        $('#twitter').sharrre({
          ...
          enableTracking: true,
          enableCounter: false,
          buttons: { twitter: {via: 'certivyTim'}},
          click: function(api, options){
            api.simulateClick();
            api.openPopup('twitter');
          },
          template: '<i class="fa fa-twitter"></i> Twitter &middot; 532',
          url: 'http://presentation.certivy-tim.com/'
        });
