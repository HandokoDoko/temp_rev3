...
<div class="section section section-regist margin-top-min20 container">
    ...
    <div class="panel-body">
        <form action="<?php echo e(url('/register')); ?>" role="form" class="smart-wizard form-horizontal" id="form" method="POST" autocomplete="off">
            <div id="wizard" class="swMain">
                ...
                <div id="step-1">
                    ...
                    <div class="form-group<?php echo e($errors->has('orgAddress') ? ' has-error' : ''); ?>">
                     ...
                     <!--<div class="form-group<?php echo e($errors->has('orgCountry') ? ' has-error' : ''); ?>">
                        ...
                        <div class="col-md-7">
                            ...
                            <?php if($errors->has('orgCountry')): ?>
                                <span class="help-block">
                                    <strong><?php echo e($errors->first('orgCountry')); ?></strong>
                                </span>
                            <?php endif; ?>
                        </div>
                    </div>-->

                     <div class="form-group<?php echo e($errors->has('orgCity') ? ' has-error' : ''); ?>">
                        <label class="col-md-3 control-label">
                            City
                        </label>
                        <div class="col-md-7">
                            ...
                            <?php if($errors->has('orgCity')): ?>
                                <span class="help-block">
                                    <strong><?php echo e($errors->first('orgCity')); ?></strong>
                                </span>
                            <?php endif; ?>
                        </div>
                    </div>
