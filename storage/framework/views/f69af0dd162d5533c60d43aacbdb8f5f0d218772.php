...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('')); ?>assets/plugins/iCheck/skins/all.css">
    <link rel="stylesheet" href="<?php echo e(asset('')); ?>assets/plugins/perfect-scrollbar/src/perfect-scrollbar.css">
    <link rel="stylesheet" href="<?php echo e(asset('')); ?>assets/plugins/animate.css/animate.min.css">
    <!-- end: MAIN CSS -->
    <!-- start: CSS REQUIRED FOR SUBVIEW CONTENTS -->
    <link rel="stylesheet" href="<?php echo e(asset('')); ?>assets/plugins/owl-carousel/owl-carousel/owl.carousel.css">
    <link rel="stylesheet" href="<?php echo e(asset('')); ?>assets/plugins/owl-carousel/owl-carousel/owl.theme.css">
    <link rel="stylesheet" href="<?php echo e(asset('')); ?>assets/plugins/owl-carousel/owl-carousel/owl.transitions.css">
    <link rel="stylesheet" href="<?php echo e(asset('')); ?>assets/plugins/summernote/dist/summernote.css">
    <link rel="stylesheet" href="<?php echo e(asset('')); ?>assets/plugins/fullcalendar/fullcalendar/fullcalendar.css">
    <link rel="stylesheet" href="<?php echo e(asset('')); ?>assets/plugins/toastr/toastr.min.css">
    <link rel="stylesheet" href="<?php echo e(asset('')); ?>assets/plugins/bootstrap-select/bootstrap-select.min.css">
    <link rel="stylesheet" href="<?php echo e(asset('')); ?>assets/plugins/bootstrap-switch/dist/css/bootstrap3/bootstrap-switch.min.css">
    <link rel="stylesheet" href="<?php echo e(asset('')); ?>assets/plugins/DataTables/media/css/DT_bootstrap.css">
    <link rel="stylesheet" href="<?php echo e(asset('')); ?>assets/plugins/bootstrap-fileupload/bootstrap-fileupload.min.css">
    <link rel="stylesheet" href="<?php echo e(asset('')); ?>assets/plugins/bootstrap-daterangepicker/daterangepicker-bs3.css">
    <!-- end: CSS REQUIRED FOR THIS SUBVIEW CONTENTS-->
    <!-- start: CSS REQUIRED FOR THIS PAGE ONLY -->
    <link rel="stylesheet" href="<?php echo e(asset('')); ?>assets/plugins/weather-icons/css/weather-icons.min.css">
    <link rel="stylesheet" href="<?php echo e(asset('')); ?>assets/plugins/nvd3/nv.d3.min.css">
    <!-- end: CSS REQUIRED FOR THIS PAGE ONLY -->
    <!-- start: CORE CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('')); ?>assets/css/styles.css">
    <link rel="stylesheet" href="<?php echo e(asset('')); ?>assets/css/styles-responsive.css">
    <link rel="stylesheet" href="<?php echo e(asset('')); ?>assets/css/plugins.css">
    <link rel="stylesheet" href="<?php echo e(asset('')); ?>assets/css/themes/theme-default.css" type="text/css" id="skin_color">
    <link rel="stylesheet" href="<?php echo e(asset('')); ?>assets/css/print.css" type="text/css" media="print"/>
    <!-- end: CORE CSS -->
    <link rel="shortcut icon" href="favicon.ico" />

    <!--     Fonts and icons     -->
    <link href='http://fonts.googleapis.com/css?family=Droid+Serif:400,700' rel='stylesheet' type='text/css'>
    <link href="<?php echo e(asset('')); ?>assets/css/fonts/pe-icon-7-stroke.css" rel="stylesheet">
    <link href="<?php echo e(asset('')); ?>assets/css/fonts/Rubik-Fonts.css" rel="stylesheet" />
...
<!-- start: BODY -->
    <body>
                    ...
                    <div class="col-md-4 col-sm-4">
                        ...
                        <div class="blog-photo-stream margin-bottom-30">
                            <ul class="list-unstyled">
                                <li>
                                    <a href="#"><img alt="" src="<?php echo e(asset('')); ?>assets/images-sample/image01_th.jpg"></a>
                                </li>
                                <li>
                                    <a href="#"><img alt="" src="<?php echo e(asset('')); ?>assets/images-sample/image02_th.jpg"></a>
                                </li>
                                <li>
                                    <a href="#"><img alt="" src="<?php echo e(asset('')); ?>assets/images-sample/image03_th.jpg"></a>
                                </li>
                                <li>
                                    <a href="#"><img alt="" src="<?php echo e(asset('')); ?>assets/images-sample/image04_th.jpg"></a>
                                </li>
                                <li>
                                    <a href="#"><img alt="" src="<?php echo e(asset('')); ?>assets/images-sample/image05_th.jpg"></a>
                                </li>
                                <li>
                                    <a href="#"><img alt="" src="<?php echo e(asset('')); ?>assets/images-sample/image06_th.jpg"></a>
                                </li>
                                <li>
                                    <a href="#"><img alt="" src="<?php echo e(asset('')); ?>assets/images-sample/image07_th.jpg"></a>
                                </li>
                                <li>
                                    <a href="#"><img alt="" src="<?php echo e(asset('')); ?>assets/images-sample/image08_th.jpg"></a>
                                </li>
                                <li>
                                    <a href="#"><img alt="" src="<?php echo e(asset('')); ?>assets/images-sample/image09_th.jpg"></a>
                                </li>
                                <li>
                                    <a href="#"><img alt="" src="<?php echo e(asset('')); ?>assets/images-sample/image10_th.jpg"></a>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="main-wrapper">
                ...
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="<?php echo e(url('/')); ?>">
                            <?php /*<img src="<?php echo e(asset('')); ?>assets/images-sample/logo.png" alt="Certivy"/>*/ ?>
                            Certivy
                        </a>
                        <!-- end: LOGO -->
                    </div>
                        ...
                        <ul class="nav navbar-right">
                            ...
                            <li class="dropdown current-user">
                                <a data-toggle="dropdown" data-hover="dropdown" class="dropdown-toggle" data-close-others="true" href="#">
                                    <img src="<?php echo e(asset('')); ?>assets/img/avatar-1-small.jpg" class="img-circle" alt="">
            ...
            <footer class="inner">
                <div class="footer-inner">
                    <div class="pull-left">
                        2014 &copy; Certivy by cliptheme.
                    </div>
                        ...
                        <div class="e-slider owl-carousel owl-theme">
                            <div class="item">
                                ...
                                <div class="panel-footer">
                                    <div class="avatar-note"><img src="<?php echo e(asset('')); ?>assets/images-sample/avatar-2-small.jpg" alt="">
                                    </div>
                            ...
                            <div class="item">
                                ...
                                <div class="panel-footer">
                                    <div class="avatar-note"><img src="<?php echo e(asset('')); ?>assets/images-sample/avatar-3-small.jpg" alt="">
                                    </div>
                            ...
                            <div class="item">
                                ...
                                <div class="panel-footer">
                                    <div class="avatar-note"><img src="<?php echo e(asset('')); ?>assets/images-sample/avatar-4-small.jpg" alt="">
                                    </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <div class="fileupload fileupload-new contributor-avatar" data-provides="fileupload">
                                        <div class="fileupload-new thumbnail"><img src="<?php echo e(asset('')); ?>assets/images-sample/anonymous.jpg" alt="" width="50" height="50"/>
                                        </div>
        ...
        <![endif]-->
        <!--[if gte IE 9]><!-->
        <script src="<?php echo e(asset('')); ?>assets/plugins/jQuery/jquery-2.1.1.min.js"></script>
        <!--<![endif]-->
        <script src="<?php echo e(asset('')); ?>assets/plugins/jquery-ui/jquery-ui-1.10.2.custom.min.js"></script>
        <script src="<?php echo e(asset('')); ?>assets/plugins/bootstrap/js/bootstrap.min.js"></script>
        <script src="<?php echo e(asset('')); ?>assets/plugins/blockUI/jquery.blockUI.js"></script>
        <script src="<?php echo e(asset('')); ?>assets/plugins/iCheck/jquery.icheck.min.js"></script>
        <script src="<?php echo e(asset('')); ?>assets/plugins/moment/min/moment.min.js"></script>
        <script src="<?php echo e(asset('')); ?>assets/plugins/perfect-scrollbar/src/jquery.mousewheel.js"></script>
        <script src="<?php echo e(asset('')); ?>assets/plugins/perfect-scrollbar/src/perfect-scrollbar.js"></script>
        <script src="<?php echo e(asset('')); ?>assets/plugins/bootbox/bootbox.min.js"></script>
        <script src="<?php echo e(asset('')); ?>assets/plugins/jquery.scrollTo/jquery.scrollTo.min.js"></script>
        <script src="<?php echo e(asset('')); ?>assets/plugins/ScrollToFixed/jquery-scrolltofixed-min.js"></script>
        <script src="<?php echo e(asset('')); ?>assets/plugins/jquery.appear/jquery.appear.js"></script>
        <script src="<?php echo e(asset('')); ?>assets/plugins/jquery-cookie/jquery.cookie.js"></script>
        <script src="<?php echo e(asset('')); ?>assets/plugins/velocity/jquery.velocity.min.js"></script>
        <script src="<?php echo e(asset('')); ?>assets/plugins/TouchSwipe/jquery.touchSwipe.min.js"></script>
        <!-- end: MAIN JAVASCRIPTS -->
        <!-- start: JAVASCRIPTS REQUIRED FOR SUBVIEW CONTENTS -->
        <script src="<?php echo e(asset('')); ?>assets/plugins/owl-carousel/owl-carousel/owl.carousel.js"></script>
        <script src="<?php echo e(asset('')); ?>assets/plugins/jquery-mockjax/jquery.mockjax.js"></script>
        <script src="<?php echo e(asset('')); ?>assets/plugins/toastr/toastr.js"></script>
        <script src="<?php echo e(asset('')); ?>assets/plugins/bootstrap-modal/js/bootstrap-modal.js"></script>
        <script src="<?php echo e(asset('')); ?>assets/plugins/bootstrap-modal/js/bootstrap-modalmanager.js"></script>
        <script src="<?php echo e(asset('')); ?>assets/plugins/fullcalendar/fullcalendar/fullcalendar.min.js"></script>
        <script src="<?php echo e(asset('')); ?>assets/plugins/bootstrap-switch/dist/js/bootstrap-switch.min.js"></script>
        <script src="<?php echo e(asset('')); ?>assets/plugins/bootstrap-select/bootstrap-select.min.js"></script>
        <script src="<?php echo e(asset('')); ?>assets/plugins/jquery-validation/dist/jquery.validate.min.js"></script>
        <script src="<?php echo e(asset('')); ?>assets/plugins/bootstrap-fileupload/bootstrap-fileupload.min.js"></script>
        <script src="<?php echo e(asset('')); ?>assets/plugins/DataTables/media/js/jquery.dataTables.min.js"></script>
        <script src="<?php echo e(asset('')); ?>assets/plugins/DataTables/media/js/DT_bootstrap.js"></script>
        <script src="<?php echo e(asset('')); ?>assets/plugins/truncate/jquery.truncate.js"></script>
        ...
        <script src="<?php echo e(asset('')); ?>assets/js/subview.js"></script>
        <script src="<?php echo e(asset('')); ?>assets/js/subview-examples.js"></script>
        <!-- end: JAVASCRIPTS REQUIRED FOR SUBVIEW CONTENTS -->
        <!-- start: JAVASCRIPTS REQUIRED FOR THIS PAGE ONLY -->
        <script src="<?php echo e(asset('')); ?>assets/plugins/jquery.pulsate/jquery.pulsate.min.js"></script>
        <script src="<?php echo e(asset('')); ?>assets/js/pages-user-profile.js"></script>
